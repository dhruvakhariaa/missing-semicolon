...
import { getDoctorById, getDoctorAvailability } from '@/lib/api';
...
const DoctorProfile = () => {
    ...
    const handleBook = () => {
        if (doctor && selectedDate && selectedSlot) {
            // In Next.js, use URL params instead of state for clearer navigation handling across clean refreshes
