...
import { createAppointment, getDoctorById } from '@/lib/api';
...
const BookingConfirmationContent = () => {
    ...
    if (!doctorId || !dateParam || !slot || (!loading && !doctor)) {
        return (
            <div className="text-center py-12 max-w-md mx-auto">
                <div className="bg-red-50 p-8 rounded-xl">
                    <p className="text-red-600 text-lg font-medium">Invalid booking details.</p>
                    <button
    ...
    if (loading) {
        return <div className="p-8 text-center text-gov-blue-600">Loading booking details...</div>;
    }
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            <button onClick={() => router.back()} className="flex items-center text-gov-blue-500 hover:text-gov-blue-700 transition-colors">
...
export default function BookingConfirmation() {
    return (
        <Suspense fallback={<div className="p-8 text-center text-gov-blue-600">Loading booking page...</div>}>
