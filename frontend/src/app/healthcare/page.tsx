        ...
        <div className="space-y-12 py-6">
                ...
                <div className="w-full max-w-6xl aspect-[21/9] bg-gradient-to-r from-gov-blue-700 to-gov-blue-500 rounded-3xl shadow-xl relative overflow-hidden flex items-center px-8 md:px-16 text-white text-left">
                    ...
                    <div className="relative z-10 space-y-6 max-w-2xl">
                        ...
                        <div className="flex gap-4 pt-2">
                            <Link href="/appointments" className="bg-white text-gov-blue-700 px-6 py-3 rounded-xl font-bold hover:bg-gov-blue-50 transition-colors shadow-lg shadow-black/10">
                                Book Appointment
                            </Link>
                            <Link href="/doctors" className="bg-gov-blue-600 border border-white/30 text-white px-6 py-3 rounded-xl font-bold hover:bg-gov-blue-500 transition-colors">
                                Find Doctors
                            </Link>
                        </div>
                    </div>
            ...
            <div className="space-y-8 max-w-6xl mx-auto px-4">
                <div className="flex flex-wrap items-center justify-start gap-8 border-b-2 border-gov-blue-100 pb-2">
                    <Link href="/healthcare" className="flex items-center gap-2 text-xl font-bold text-gov-blue-700 border-b-4 border-gov-blue-600 -mb-[10px] pb-2 hover:text-gov-black transition-colors">
