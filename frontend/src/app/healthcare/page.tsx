    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-brand-50 via-white to-brand-100 flex items-center justify-center px-4">
            <div className="text-center max-w-md">
                ...
                {/* Title */}
                <h1 className="text-4xl font-bold text-brand-800 mb-4">Healthcare Services</h1>
                ...
                <p className="text-lg text-brand-600 mb-8">
                    We're working hard to bring you comprehensive healthcare services including appointment booking,
                    telemedicine, and medical records management.
                </p>
