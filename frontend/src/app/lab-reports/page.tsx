                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {report.status === 'completed' && (
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => {
                                                if (report.resultUrl && report.resultUrl !== '#') {
                                                    window.open(report.resultUrl, '_blank');
                                                } else {
                                                    alert('This is a demo report. In a real app, this would open the PDF.');
                                                }
                                            }}
                                            className="p-2 bg-gov-blue-50 text-gov-blue-600 rounded-lg hover:bg-gov-blue-100 transition-colors"
                                            title="View Report"
                                        >
                                        ...
                                        <button
                                            onClick={() => {
                                                if (report.resultUrl && report.resultUrl !== '#') {
                                                    ...
                                                    link.href = report.resultUrl;
                                                    link.download = `${report.testName.replace(/\s+/g, '_')}_Report.pdf`;
                                                    document.body.appendChild(link);
                                                    link.click();
                                                    document.body.removeChild(link);
                                                } else {
                                                    alert('This is a demo report. In a real app, this would download the PDF.');
                                                }
                                            }}
